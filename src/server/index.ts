...
import uploadOss from 'controller/uploadOss';
import paths from '../../config/paths';
// import { configureStore } from '../shared/store';
import uploadS3 from '../server/controller/uploadS3';
...
app.use('/api/upload', (res, req, next) => uploadS3(res, req, next));

app.use('/api/uploadImage', (res, req, next) => uploadOss(res, req, next));
